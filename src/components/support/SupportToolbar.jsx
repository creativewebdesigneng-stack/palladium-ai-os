import { Ticket, Users, Headset, MessagesSquare, BookOpen, Workflow, Plus } from 'lucide-react';
import { NAV } from './supportData';

const ICONS = { Ticket, Users, Headset, MessagesSquare, BookOpen, Workflow };

export default function SupportToolbar({ view, setView, onCreate }) {
  return (
