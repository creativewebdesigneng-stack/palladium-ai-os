...
export default function CurrentPlan({ onUpgrade, onChange }) {
  const { user } = useAuth();
    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
      ...
      <div className="relative flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {isPaid && (
            <button className="pbtn pbtn-secondary flex items-center gap-1.5 rounded-xl border border-red-400/20 px-4 py-2 text-sm text-red-300 hover:bg-red-500/10">
