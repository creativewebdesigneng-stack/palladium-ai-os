...
export default function TeamToolbar({ query, setQuery, activeTab, setActiveTab, resultCount, tabs = [] }) {
  return (
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-1 items-center gap-2">
          <div className="relative flex-1 lg:max-w-xs">
            ...
            <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search members, roles…"
