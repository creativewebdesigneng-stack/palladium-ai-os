...
import { TABS } from './teamData';

export default function TeamToolbar({ query, setQuery, activeTab, setActiveTab, resultCount }) {
  return (
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-1 items-center gap-2">
          <div className="relative flex-1 lg:max-w-xs">
            ...
            <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search members, teams, roles…"
          ...
          <span className="hidden text-[11px] text-zinc-500 sm:inline">{resultCount} results</span>
        </div>
