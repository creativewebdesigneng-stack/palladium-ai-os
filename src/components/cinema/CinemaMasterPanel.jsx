...
export default function CinemaMasterPanel({project,workerConfigured}){
  ...
  return <div className="mt-4 rounded-xl border border-white/8 bg-black/25 p-4">
    ...
    {workerConfigured&&<p className="mt-2 text-[10px] text-emerald-200/60">Blackstar Cinema mastering is online. Final assembly is enabled once every required shot segment has completed.</p>}
