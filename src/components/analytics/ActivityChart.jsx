...
import { ACTIVITY } from './analyticsData';
...
export default function ActivityChart({ range, setRange }) {
    ...
    <div className="rounded-2xl border border-white/10 bg-white/[.03] p-4">
      <div className="mb-3 flex items-center justify-between">
        <div>
          ...
          <p className="text-[11px] text-zinc-500">Users & requests by {range} interval</p>
        </div>
      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={data} margin={{ left: -8, right: 8, top: 4 }}>
            ...
            <Line dataKey="users" stroke="#06b6d4" strokeWidth={2} dot={false} />
          </ComposedChart>
        </ResponsiveContainer>
      </div>
    </div>
