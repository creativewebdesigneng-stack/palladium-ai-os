import { FileText, Receipt, FileBarChart, CreditCard, Wallet, Loader2 } from 'lucide-react';
import { AI_TOOLS } from './financeData';

const ICONS = { FileText, Receipt, FileBarChart, CreditCard, Wallet };

export default function AIFinancePanel({ onRun, running }) {
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[.03] p-4">
      <div className="mb-3"><h3 className="text-sm font-semibold text-white">AI Finance Tools</h3><p className="text-[11px] text-zinc-500">Automate invoicing, expenses, and reporting</p></div>
