  ...
  try {
    const res = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You write a two-sentence daily briefing for an AI operating system. British English, calm and factual. Never give medical or financial advice. Do not invent numbers beyond the data given.' },
