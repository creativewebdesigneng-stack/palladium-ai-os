...
export const INTEGRATION_PROVIDERS: IntegrationProvider[] = [
  {
    ...
    summary: "Gmail drafting, Google Calendar availability/event creation and Drive document lookup.",
    scopes: [
      "openid",
      "email",
      "profile",
    ...
    tools: ["connected_service", "email_send", "calendar"],
  ...
  },
  {
    ...
    name: "Microsoft 365",
    category: "productivity",
    summary: "Outlook drafting, Microsoft Calendar reads/event creation and OneDrive file reading.",
    scopes: [
      "offline_access",
      "openid",
      "email",
