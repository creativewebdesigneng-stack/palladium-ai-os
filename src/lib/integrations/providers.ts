...
export const INTEGRATION_PROVIDERS: IntegrationProvider[] = [
  ...
  },
  {
    ...
    name: "Salesforce",
    category: "crm",
    summary: "OAuth connection is available; provider-specific CRM reads are still being implemented.",
  ...
  },
  {
    ...
    summary: "OAuth connection is available; provider-specific page/database reads are still being implemented.",
    scopes: [],
  ...
  },
  {
    ...
    name: "Asana",
    category: "project_management",
    summary: "OAuth connection is available; provider-specific task/project reads are still being implemented.",
    scopes: ["default"],
    tools: ["http_request"],
