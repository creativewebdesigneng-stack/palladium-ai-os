...
export const INTEGRATION_PROVIDERS: IntegrationProvider[] = [
  {
    ...
    summary: "Gmail drafting, Google Calendar availability and Drive document lookup.",
    scopes: [
      "openid",
      "email",
      "profile",
  ...
  },
  {
    ...
    name: "Microsoft 365",
    category: "productivity",
    summary: "Outlook mail drafting, Microsoft Calendar and OneDrive file reading.",
    scopes: [
      "offline_access",
      "openid",
      "email",
  ...
  },
  {
    ...
    summary: "Read channel context and post agent updates once approved.",
  ...
  },
  {
    ...
    name: "Discord",
    category: "communication",
    summary: "Deliver agent notifications to a server channel your account can post in.",
  ...
  },
  {
    ...
    name: "HubSpot",
    category: "crm",
    summary: "CRM context: companies, contacts and deals your agents can research.",
  ...
  },
  {
    ...
    name: "Salesforce",
    category: "crm",
    summary: "Read accounts, opportunities and activity for CRM-aware agents.",
  ...
  },
  {
    ...
    summary: "Read project pages and databases as agent knowledge.",
    scopes: [],
  ...
  },
  {
    ...
    name: "Asana",
    category: "project_management",
    summary: "Track tasks and projects so workforces can report real delivery status.",
    scopes: ["default"],
    tools: ["http_request"],
  ...
  },
  {
    ...
    name: "Linear",
    category: "project_management",
    summary: "Read issues and cycles for engineering workforce reporting.",
    scopes: ["read"],
    tools: ["http_request"],
