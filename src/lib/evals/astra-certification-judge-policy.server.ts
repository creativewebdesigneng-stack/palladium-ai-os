import { ASTRA_CERTIFICATION_JUDGES, type AstraCertificationJudge } from './astra-certification-judge-policy'
...
export function listServerApprovedAstraCertificationJudges(): readonly ServerAstraCertificationJudge[] {
  ...
  if (!config.configured || !config.model) return ASTRA_CERTIFICATION_JUDGES
  return [
