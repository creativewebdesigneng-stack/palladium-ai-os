...
export type AstraCertificationTaskClass = Exclude<NativeIntelligenceTaskClass, 'vision'>
...
export function isAstraCertificationTaskClass(
  taskClass: NativeIntelligenceTaskClass,
): taskClass is AstraCertificationTaskClass {
...
export function listAstraCertificationBenchmarkCases(
  taskClass: AstraCertificationTaskClass,
): AstraCertificationBenchmarkCase[] {
...
export function getAstraCertificationBenchmarkCase(
  taskClass: NativeIntelligenceTaskClass,
  caseId: string,
): AstraCertificationBenchmarkCase | null {
