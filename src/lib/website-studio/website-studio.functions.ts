...
const projectSchema=z.object({
  ...
  appConfig:z.record(z.string(),z.unknown()).default({}),
  gitConfig:z.record(z.string(),z.unknown()).default({}),
  domainConfig:z.record(z.string(),z.unknown()).default({}),
...
export const saveWebsiteStudioProject=createServerFn({method:'POST'})
  ...
  .handler(async({data,context})=>{
    ...
    const row={
      ...
      domain_config:data.domainConfig,
      html:data.html,
      css:data.css,
...
const revisionSnapshot=z.object({
  ...
  app_config:z.record(z.string(),z.unknown()).optional(),
  git_config:z.record(z.string(),z.unknown()).optional(),
  domain_config:z.record(z.string(),z.unknown()).optional(),
