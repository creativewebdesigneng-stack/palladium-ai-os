...
export const Route = createFileRoute("/email-verification")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Confirm your email address to activate your PalladiumAI workspace." },
      { property: "og:title", content: "Verify your email — PalladiumAI" },
      { property: "og:description", content: "Confirm your email address to activate your PalladiumAI workspace." },
