...
import { BookOpen, Boxes, Cpu, Wrench } from 'lucide-react';
      ...
      <section className="relative overflow-hidden px-6 pb-14 pt-32">
        ...
        <SectionReveal className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-6 text-4xl font-semibold leading-[1.05] tracking-tight text-white sm:text-5xl md:text-6xl">
            Product resources,
            <span className="text-violet-300"> without invented content.</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
            A public article and case-study feed is not connected yet. Static publication counts and sample articles stay removed until a real CMS exists.
          </p>
        </SectionReveal>
      </section>
          ...
          <SectionReveal>
            <div className="grid gap-4 sm:grid-cols-2">
              {destinations.map(({ to, icon: Icon, title, text }) => (
                <Link key={to} to={to} className="blackstar-panel rounded-2xl p-5 transition hover:bg-white/[.05]">
