...
import { ResourceSearch, ResourceGrid, SectionGrid, ResourceCta } from '@/components/site/ResourcesShowcase';
import { RECENT } from '@/components/site/resourcesData';
      ...
      <section className="relative overflow-hidden px-6 pb-12 pt-32">
        ...
        <SectionReveal className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-6 text-4xl font-semibold leading-[1.05] tracking-tight text-white sm:text-5xl md:text-6xl">
            ...
            <span className="bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-400 bg-clip-text text-transparent"> build with AI.</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
            Documentation, guides, tutorials, research, case studies and community — all in one place.
          </p>
        </SectionReveal>
      </section>

      {/* Sections */}
      <section className="py-12"><SectionGrid /></section>

      {/* Search + articles */}
      <section className="py-12">
        <div className="mx-auto max-w-7xl px-6">
          <ResourceSearch query={query} setQuery={setQuery} active={active} setActive={setActive} results={results} />
        </div>
        <div className="mt-10"><ResourceGrid query={query} active={active} /></div>
      </section>

      {/* CTA */}
      <section className="py-24">
        <SectionReveal><ResourceCta /></SectionReveal>
      </section>
