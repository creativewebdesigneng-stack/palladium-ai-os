...
export default function AdminSubscriptions() {
  ...
  const handleAction = (type) => { flash(`${type} is not yet wired to a backend endpoint.`); setSelected(null); };
