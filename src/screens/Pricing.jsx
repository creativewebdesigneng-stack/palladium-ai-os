    ...
    <div className="blackstar-public-page blackstar-public-pricing relative min-h-screen text-zinc-100">
      ...
      <section className="relative overflow-hidden pt-32 pb-12">
        ...
        <SectionReveal className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-zinc-400">Every plan includes the Blackstar platform. Choose monthly or yearly billing and scale your AI workforce as you grow.</p>
        </SectionReveal>
      </section>
