-- Reconcile missing Autonomous OS foundation against the existing workforce
-- and workflow ledgers. Reuses the original checked-in schema, no duplicate
-- runtime and no automatic scheduler activation.
...
-- Preserve Blackstar's original owner-scoped RLS while making API grants explicit.
revoke all on public.autonomous_goals,public.autonomous_goal_runs,
  public.autonomous_goal_events,public.autonomous_goal_fleet_assignments
  from public,anon,authenticated;
grant all on public.autonomous_goals,public.autonomous_goal_runs,
  public.autonomous_goal_events,public.autonomous_goal_fleet_assignments
  to service_role;
grant select,insert,update,delete on public.autonomous_goals,
  public.autonomous_goal_runs,public.autonomous_goal_fleet_assignments
  to authenticated;
