...
const pub = [
  [
    ...
    "Landing",
    "/",
    "PalladiumAI — The AI Operating System",
  ...
  [
    ...
    "Payment",
    "/payment",
    "Checkout — PalladiumAI",
    "Complete your PalladiumAI subscription and activate your AI workforce.",
  ],
  [
    "403",
    "Forbidden",
    "/403",
    "Access denied — PalladiumAI",
  ...
  [
    ...
    "ServerError",
    "/500",
    "Something went wrong — PalladiumAI",
    "An unexpected error occurred. Our systems are on it.",
  ],
];
...
const auth = [
  [
    ...
    "/login",
    "Sign in — PalladiumAI",
    "Sign in to your PalladiumAI workspace and resume your AI workforce.",
  ],
  [
    "register",
    "Register",
    "/register",
    "Create account — PalladiumAI",
    "Create your PalladiumAI account and deploy your first AI agents in minutes.",
  ],
  [
    "forgot-password",
    "ForgotPassword",
    "/forgot-password",
    "Reset password — PalladiumAI",
    "Request a secure password reset link for your PalladiumAI account.",
  ],
  [
    "reset-password",
    "ResetPassword",
    "/reset-password",
    "Choose a new password — PalladiumAI",
    "Set a new password for your PalladiumAI account.",
  ],
  [
    "two-factor",
    "TwoFactor",
    "/two-factor",
    "Two-factor verification — PalladiumAI",
    "Confirm your identity with a second factor to protect your workspace.",
  ],
  [
    "onboarding",
    "Onboarding",
    "/onboarding",
    "Welcome — PalladiumAI",
    "Set up your workspace, pick departments and meet your AI workforce.",
  ],
  [
    "email-verification",
    "EmailVerification",
    "/email-verification",
    "Verify your email — PalladiumAI",
    "Confirm your email address to activate your PalladiumAI workspace.",
  ],
];
...
const app = [
  [
    ...
    "Dashboard",
    "Dashboard",
    "Your AI workforce at a glance: live missions, agents and outcomes.",
  ],
  ...
  [
    ...
    "AgentBuilder",
    "Agent builder",
    "Design agent behaviour, tools and guardrails visually.",
  ],
  [
    "agents.$id.index",
    "AgentDetail",
    "Agent detail",
    "Inspect an agent’s configuration, tools and performance.",
  ],
  [
    "agents.$id.playground",
    "AgentPlayground",
    "Agent playground",
    "Test an agent live before deploying it to production.",
  ],
  ...
  [
    ...
    "FileAnalysis",
    "File analysis",
    "Extract insight from documents, sheets and media.",
  ],
  ...
  [
    ...
    "Marketplace",
    "Marketplace",
    "Install capabilities, templates and integrations.",
  ],
  [
    "agent-marketplace",
    "AgentMarketplace",
    "Agent marketplace",
    "Hire pre-built agents from the community.",
  ],
  ...
  [
    ...
    "CreatorProfile",
    "Creator profile",
    "Browse a creator’s published agents and reviews.",
  ],
  [
    "automation",
    "AutomationStudio",
    "Automation studio",
    "Build multi-step automations with triggers and approvals.",
  ],
  ...
  [
    ...
    "ToolsFramework",
    "Tools framework",
    "Define, test and permission the tools agents can call.",
  ],
  ...
  [
    ...
    "ToolMarketplace",
    "Tool marketplace",
    "Add new tools and connectors to your workspace.",
  ],
  [
    "computer-control",
    "ComputerControl",
    "Computer control",
    "Let agents operate a browser and desktop safely.",
  ],
  ...
  [
    ...
    "DeveloperWorkspace",
    "Developer workspace",
    "Code, run and ship with agent pair-programming.",
  ],
  [
    "code-explorer",
    "CodeExplorer",
    "Code explorer",
    "Navigate and understand any codebase with AI.",
  ],
  ...
  [
    ...
    "DeveloperPortal",
    "Developer portal",
    "API keys, webhooks and platform docs.",
  ],
  [
    "version-control",
    "GitControl",
    "Version control",
    "Branches, reviews and commits with agent assistance.",
  ],
  [
    "business-intelligence",
    "BusinessIntelligence",
    "Business intelligence",
    "Ask questions of your data and get decisions.",
  ],
  ...
  [
    ...
    "BusinessAutomation",
    "Business automation",
    "Automate back-office processes end to end.",
  ],
  ...
  [
    ...
    "CustomerSupport",
    "Customer support",
    "Resolve tickets with agents and human escalation.",
  ],
  ...
  [
    ...
    "AIMarketplace",
    "AI marketplace",
    "Discover everything you can add to your OS.",
  ],
  ...
  [
    ...
    "AdminOrganisations",
    "Admin · Organisations",
    "Manage tenants and organisations.",
  ],
  [
    "admin.subscriptions",
    "AdminSubscriptions",
    "Admin · Subscriptions",
    "Plans, entitlements and renewals.",
  ],
  [
    "admin.platform-analytics",
    "AdminPlatformAnalytics",
    "Admin · Platform analytics",
    "Usage and growth across the platform.",
  ],
  [
    "admin.security",
    "AdminSecurity",
  ...
  [
    ...
    "SystemMonitoring",
    "Admin · Monitoring",
    "Health, latency and incident signals.",
  ],
  [
    "admin.marketplace",
    "AdminMarketplaceReview",
    "Admin · Marketplace review",
    "Review and approve submitted agents.",
  ],
];
...
const write = (file, body) => {
  fs.mkdirSync(`src/routes/${file.includes("/") ? file.slice(0, file.lastIndexOf("/")) : ""}`, {
    recursive: true,
  });
